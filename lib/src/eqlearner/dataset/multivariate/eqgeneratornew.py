...
def polynomial_single(tracker, constant_interval=[(1,1)], num_elements=None):
    ...
    chosen = tracker.sample()
    elem_without_constant, elem_with_constant = EquationStructures.polynomial_joiner(chosen, constant_interval, num_elements=num_elements)

    #expression.append(elem_with_constant)
    return utils_dataclasses.Function(elem_without_constant,elem_with_constant)
